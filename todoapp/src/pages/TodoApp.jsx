  ...
  return (
    <>
      ...
      <div>
        ...
        <button onClick={() => addNew()} disabled={addButtonLoading}>
          +
        </button>
      </div>
      <br />
      ...
      {todos.map((todo) => {
        return (
          <div key={todo.id} className = {style.bigBox} >
            <div
              style={{
            ...
            <button onClick={() => deleteTodoData(todo.id)} className= {style.deletebtn}>Delete</button>
